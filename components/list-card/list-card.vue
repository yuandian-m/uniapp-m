<template>
	<view @click="open">
		<!-- 基础卡片 -->
		<view v-if="cardInfo.mode === 'base'" class="listcard">
			...
			<view class="listcard-content">
				...
				<view class="listcard-content__des">
					<view class="listcard-content__des-label">
						<view class="listcard-content__des-label-item">{{cardInfo.classify}}</view>
					</view>
					<view class="listcard-content__des-browse">{{cardInfo.browse_count}}浏览</view>
				</view>
			</view>
		</view>

		<!-- 多图模式 -->
		<view v-if="cardInfo.mode === 'column'" class="listcard mode-column">
			<view class="listcard-content">
				<view class="listcard-content__title">
					<text>{{cardInfo.title}}</text>
						<likes :item="cardInfo"></likes>
				...
				<view class="listcard-image">
					<view v-if="index < 3"  v-for="(item,index) in cardInfo.cover" :key="index" class="listcard-image__item">
		...
		<!-- 大图模式 -->
		<view v-if="cardInfo.mode === 'image'" class="listcard mode-image">
			<view class="listcard-image">
				<image :src="cardInfo.cover[0]" mode="aspectFill"></image>
			</view>
			<view class="listcard-content">
